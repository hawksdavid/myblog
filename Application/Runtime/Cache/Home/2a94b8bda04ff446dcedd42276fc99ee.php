						...
						<div class="header-top d-flex justify-content-between align-items-center">
							...
							<div class="main-menubar d-flex align-items-center">
								<nav class="hide">
									...
									<a href="<?php echo U('Generic/index');?>">Generic</a>
									<a href="<?php echo U('Elements/index');?>">Elements</a>
								</nav>
			...
			<section class="amazing-works-area">
				<div class="container">
					...
					<div class="active-works-carousel mt-40">
						<div class="item">
							<div class="thumb" style="background: url(/Public/img/c1.jpg);"></div>
			...
			<div class="brand-area">
				<div class="container">
					<div class="total-brand d-flex justify-content-around">
						<img src="/Public/img/b1.png" alt="">
						<img src="/Public/img/b2.png" alt="">
						<img src="/Public/img/b3.png" alt="">
						<img src="/Public/img/b4.png" alt="">
						<img src="/Public/img/b5.png" alt="">
					</div>
				</div>
			</div>
				...
				<footer>
					<div class="container">
						<div class="footer-content d-flex justify-content-between align-items-center flex-wrap">
							<div class="logo">
								<a href="index.html"><img src="/Public/img/f-logo.png" alt=""></a>
							</div>
